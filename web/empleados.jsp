                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Empleados creados</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=control.getCantidadEmpleados()%></div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <!-- Content Column -->
                            ...
                            <div class="col-lg-6">
                                <!--  crear usuario --> 
                               <a href="crearEmpleado.jsp" class="btn btn-success btn-icon-split">
                                    ...
                                    <tr>
                                        ...
                                        %>
                                            ...
                                            <td><%
                                                ...
                                                if(emple.getListaJuegos().isEmpty()) {
                                                
                                                } else {
                                                    int i = 0;
                                                    for(Juego jue:emple.getListaJuegos()) {
                                                        i += 1;
                                                           if(emple.getListaJuegos().size() != 1 && emple.getListaJuegos().size() != i){
                                                        out.print(jue.getDescripcionJuego()+", ");
                                                    } else  {
                                                                       out.print(jue.getDescripcionJuego());
                                                           }
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="modificarEmpleado.jsp?id=<%=emple.getIdEmpleado()%>">Modificar empleado</a>
                                            <a class="dropdown-item" href="ServletBorrarEmpleado?id=<%=emple.getIdEmpleado()%>">Borrar empleado</a> 
                                        </div>
                                    </div></td>
                                        </tr>
                                        <% } %>
