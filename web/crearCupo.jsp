                    ...
                    <!-- Content Row -->
                        ...
                        <!-- Content Column -->
                          ...
                          <div class="col-lg-12">
                              ...
                              <form action="ServletCrearCupo" method="POST">
                                  <div class="form-group">
                                      <label>Fecha</label>
                                      <input type="date" class="form-control" name="fecha" value="<%=metodosFecha.getFechaActual()%>" placeholder="Ingrese la fecha" data-validate = "Ingrese la fecha" required>
                                  </div>
                                 <div class="form-group">
                                     
                                      <label>Cantidad cupos disponibles</label>
                                      <input type="number" class="form-control" name="cupos" placeholder="Ingrese la cantidad de cupos disponibles" data-validate = "Ingrese la cantidad de cupos disponibles" required>
                                  </div>
                                                                 <div class="form-group">
