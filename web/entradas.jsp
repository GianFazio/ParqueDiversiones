                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Content Column -->
                            ...
                            <div class="col-lg-12">
                                <!--  crear usuario --> 
                               <a href="crearEntrada.jsp" class="btn btn-success btn-icon-split">
                        ...
                        <div class="col-sm-12" style="margin-top:10px;">
                            ...
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        %>
                                            <td><%=entra.getIdEntrada() %></td>
                                            <td><%=entra.getFechaUtilizar() %></td>
                                            <td><%=entra.getUnJuego().getDescripcionJuego() %></td>
                                            <td><%=entra.getCliente().getNombre()+" - "+entra.getCliente().getApellido()+" - "+entra.getCliente().getDni() %></td>
                                            <td><div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Accion
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="modificarJuego.jsp?id=<%=entra.getIdEntrada() %>">Modificar cupo</a>
                                            <a class="dropdown-item" href="ServletBorrarJuego?id=<%=entra.getIdEntrada() %>">Borrar cupo</a>
                                        </div>
                                    </div></td>
                                        </tr>
                                        <% } %>
