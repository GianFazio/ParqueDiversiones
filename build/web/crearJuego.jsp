                    ...
                    <!-- Content Row -->
                        ...
                        <!-- Content Column -->
                          ...
                          <div class="col-lg-12">
                              ...
                              <form action="ServletCrearJuego" method="POST">
                                  <div class="form-group">
                                      <label>Descripción Juego</label>
                                      <input type="text" class="form-control" name="juego" placeholder="Ingrese la descripción del juego" data-validate = "Ingrese la descripción del juego" required>
                                  </div>
                                  <div class="form-group">
                                      <label>Horario inicio</label>
                                      <input type="time" class="form-control" name="horarioInicio" placeholder="Ingrese el horario inicio" data-validate = "Ingrese el horario inicio" required>
                                  </div>
                                  <div class="form-group">
                                      <label>Horario Fin</label>
                                      <input type="time" class="form-control" name="horarioFin" placeholder="Ingrese el horario fin" data-validate = "Ingrese el horario fin" required>
                                  </div>
                               
                                  <div class="form-check">
                                      <input class="form-check-input" name="habilitado" type="checkbox">
