                    ...
                    <!-- Content Row -->
                        ...
                        <!-- Content Column -->
                          ...
                          <div class="col-lg-12">
                              ...
                              <form action="ServletCrearEmpleado" method="POST">
                                  ...
                                  <div class="form-group">
                                      <label>Cargo</label>
                                      <input type="text" class="form-control" name="cargo" placeholder="Ingrese el cargo" data-validate = "Ingrese el cargo" required>
                                  </div>
                                  ...
                                  <div class="form-group row" >
                                      ...
                                      <input class="form-check-input" name="<%="Juego"+jue.getIdJuego()%>" type="checkbox">
