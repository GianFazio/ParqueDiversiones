...
<%                                         Controladora control = new Controladora();
                                        List<Cupo> listaCupos = control.getListaCupos(); 
                                 %>
<!DOCTYPE html>
<html lang="es">
    <%
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top">
                    <h1 class="h3 mb-0 text-gray-800">Cupos</h1>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Content Column -->
                            ...
                            <div class="col-lg-12">
                                <h3>Administración de cupos</h3>
                            </div>
                            <div class="col-lg-12">
                                <!--  crear usuario --> 
                               <a href="crearCupo.jsp" class="btn btn-success btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-users"></i>
                                        </span>
                                        <span class="text">Crear Cupo</span>
                                    </a>
                            ...
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                    ...
                                    <tr>
                                        <%
                                            ...
                                            for (Cupo cup:listaCupos){
                                            
                                            
                                        %>
                                            <td><%=cup.getIdCupo()%></td>
                                            <td><%=cup.getJuego().getIdJuego()+" - "+ cup.getJuego().getDescripcionJuego() %></td>
                                            <td><%=cup.getFechaCupo() %></td>
                                            <td><%=cup.getCuposDisponible()%></td>
                                            <td><div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Accion
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="modificarJuego.jsp?id=<%=cup.getIdCupo()%>">Modificar cupo</a>
                                            <a class="dropdown-item" href="ServletBorrarJuego?id=<%=cup.getIdCupo()%>">Borrar cupo</a>
                                        </div>
                                    </div></td>
                                        </tr>
                                        <% } %>
