                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Usuarios creados</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=control.getCantidadUsuarios()%></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=control.getCantidadUsuariosAdmin()%></div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <!-- Content Column -->
                            ...
                            <div class="col-lg-6">
                                <!--  crear usuario --> 
                               <a href="crearUsuario.jsp" class="btn btn-success btn-icon-split">
                            ...
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        %>
                                            ...
                                            <td><%=usu.getUnEmpleado().getNombre()%></td>
                                            <td><%=usu.getUnEmpleado().getApellido()%></td>
                                            <td><%=usu.getEmail()%></td>
                                            <td><%if (usu.isEsAdministrador()==true){
                                                out.print("Si");
                                            } else { 
                                                out.print("No");
                                            }
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="modificarUsuario.jsp?id=<%=usu.getIdUsuario()%>">Modificar usuario</a>
                                            <a class="dropdown-item" href="ServletBorrarUsuario?id=<%=usu.getIdUsuario()%>">Borrar usuario</a>
                                        </div>
                                    </div></td>
                                        </tr>
                                        <% } %>
