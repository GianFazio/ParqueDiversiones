                          ...
                          <div class="col-lg-12">
                              ...
                              <form action="ServletCrearUsuario" method="POST">
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="usuario" placeholder="Ingrese el nombre de usuario" data-validate = "Ingrese nombre de usuario" required>
                                  </div>
                                  <div class="form-group">
                                      <label>Contraseña</label>
                                      <input type="text" class="form-control" name="password" placeholder="Ingrese la contraseña" data-validate = "Ingrese la password" required>
                                  </div>
                                  <div class="form-group">
                                      <label>Email</label>
                                      <input type="email" class="form-control" name="email" placeholder="Ingrese el email" data-validate = "Ingrese el email" required>
                                  </div>
                                  <div class="form-group">
